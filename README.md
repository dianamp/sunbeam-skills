...
| Skill | What it does |
|-------|-------------|
| run-self-feedback | Reviews how you performed on your own recorded calls and writes a weekly review: 2 strengths, top 3 improvements, goals for next week |
...
4. Writes the review using a fixed template: 2 things you did well, top 3 things to improve, 1–2 goals for next week that are observable in a transcript. Every item carries a direct quote. The whole thing reads in about five minutes.
